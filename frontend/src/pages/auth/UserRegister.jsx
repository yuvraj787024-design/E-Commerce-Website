...
const UserRegister = () => {
  ...
  return (
    ...
    >
      <div
        className={`w-full max-w-md rounded-3xl backdrop-blur-lg shadow-2xl border p-8 transition-all duration-500 relative overflow-hidden ${
          darkTheme
      ...
      >
        ...
        <div className="text-center mb-6">
          <h1 className={`text-3xl font-bold transition-colors ${darkTheme ? "text-white" : "text-gray-800"}`}>
            Create Account
          </h1>
          <p className={`mt-2 transition-colors ${darkTheme ? "text-gray-400" : "text-gray-500"}`}>
            Join us and explore delicious meals 🍔
          </p>
        </div>
